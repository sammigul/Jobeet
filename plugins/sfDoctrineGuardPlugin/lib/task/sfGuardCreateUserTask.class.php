...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $user->setemail_address($arguments['email_address']);
    $user->setusername($arguments['username']);
    $user->setpassword($arguments['password']);
    $user->setfirst_name($arguments['first_name']);
    $user->setlast_name($arguments['last_name']);
    $user->setis_active(true);
    $user->setis_super_admin($options['is-super-admin']);
    $user->save();
