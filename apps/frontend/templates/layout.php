...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    <!-- <title>Jobeet - Your best job board</title> -->
      <!-- inlclude_slot is helper method that returns true if the slot has been defined -->
    <title>
  ...
  <body>
    <div id="container">
      <div id="header">
        <div class="content">
          <h1><a href="<?php echo url_for('localized_homepage') ?>">
      ...
      <div id="footer">
        <div class="content">
          ...
          <?php include_component('sfJobeetLanguage', 'language') ?> // first argumen
          <!-- updated includecomponnet -->
